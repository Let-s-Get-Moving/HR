 ...
 * This script will be executed on Render to set up all required tables
 */
...
async function runRenderMigrations() {
  try {
    ...
    console.log('🎉 All Render migrations completed successfully!');
    return true;
...
// Run migrations
runRenderMigrations().then(success => {
  if (success) {
